...
public class FunnelChart02View extends DemoView {
    ...
    private void chartRender() {
        try {
            ...
            chart.setLabelAlign(XEnum.HorizontalAlign.RIGHT);
            chart.getLabelPaint().setColor(Color.WHITE);
            chart.getLabelPaint().setTextSize(20);
            chart.setPlotWidthPercent(50f);
    ...
    private void chartDataSet() {
        ...
        FunnelData fd1 = new FunnelData("知晓-1", 80, Color.RED);
        chartData.add(fd1);
        chartData.add(new FunnelData("详尽比较-2", 60, Color.rgb(243, 75, 125)));
        chartData.add(new FunnelData("决策-1", 40, Color.rgb(77, 180, 123)));
        chartData.add(new FunnelData("引起注意-0", 100, Color.BLUE));
        chartData.add(new FunnelData("购买-0", 20, Color.rgb(117, 197, 141)));
    }
